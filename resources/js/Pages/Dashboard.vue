                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col"><span
                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Plants</span>
                                    <span class="h3 font-bold mb-0">{{ plants_count }}</span>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="mt-2 mb-0 text-sm"><span
                                    ...
                                    class="text-nowrap text-xs text-muted">Kilowatts increase</span></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col"><span
                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Clients</span> <span
                                        class="h3 font-bold mb-0">{{ clients_count }}</span></div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col"><span class="h6 font-semibold text-muted text-sm d-block mb-2">Total
                                        Units Generated</span>
                                    <span class="h3 font-bold mb-0">{{ totalGeneratedEnergy }} <small>Kw</small></span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col"><span
                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Algorithm
                                        Efficiency</span> <span class="h3 font-bold mb-0">{{ algorithEfficiency
                                        }}</span></div>
                                <div class="col-auto">
