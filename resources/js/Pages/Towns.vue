    ...
    methods: {
        submit() {
            if (this.selectedTown) {
                this.form.put(`towns/${this.selectedTown.id}`, {
                    onSuccess: () => {
                        this.form.reset();
        ...
        deleteTown(town) {
            this.$inertia.delete(`towns/${town.id}`, {
                onSuccess: () => {
                    this.$emit('refresh');
                }
            });
        ...
        edit(town) {
            ...
            this.form.name = town.name;
            this.form.number_of_clients = town.number_of_clients;
            this.form.number_of_districts = town.number_of_districts;
            this.form.city_id = town.city_id;
        },
    ...
    <AppLayout title="Dashboard">
                ...
                <div class=" pt-6">
                    <div class="row align-items-center">
                        <div class="col-sm col-12">
                            <h1 class="h2 ls-tight">All Towns</h1>
                        </div>
        ...
        <div class="offcanvas offcanvas-end w-full w-lg-1/3" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1"
            ...
            <div class="offcanvas-header border-bottom py-4 bg-surface-secondary">
                <h5 class="offcanvas-title" id="offcanvasCreateLabel">{{ selectedTown ? 'Update' : 'New' }} Province
        ...
        <div class="container-fluid mt-4">
            <div class="vstack gap-4">
                ...
                <div class="card">
                        ...
                        <table class="table table-hover table-nowrap">
                            ...
                            <tbody>
                                <tr v-for="town in towns">
                                    ...
                                    <td>{{ town.number_of_clients }} households</td>
                                    <td>{{ town.city?.name }}</td>
                                    <td>{{ town.number_of_districts }}</td>

                                    <td class="text-end">
                                        <a href="#offcanvasCreate" @click="edit(town)" data-bs-toggle="offcanvas"
                                            class="btn btn-sm btn-square btn-neutral"><i class="bi bi-pencil"></i>
                                        </a>

                                        <button type="button" @click="deleteTown(town)"
                    ...
                    <div class="card-footer border-0 py-5"><span class="text-muted text-sm">Showing {{ towns.length
