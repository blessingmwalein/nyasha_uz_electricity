...
(1, 'Blessing Mwale', 'blessingmwalein@gmail.com', '772440088', '6 faiway Mt Pleasant Harare', 10, 2, NULL, 1, NULL, NULL, '2024-04-25 11:53:55', '2024-04-25 11:53:55', 0.00);
...
(1, 'Kariba Plant', 'Hydrogen', 10000.00, 1000.00, 'Kariba Zimbabwe', '2024-04-25 12:15:33', '2024-04-25 12:15:33', 1),
...
('5ASFLHXxqyVA62LRH80GgjE0mF3FGUKv8oowfSAo', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '', 1716295779);
...
ALTER TABLE `clients`
  ...
  ADD UNIQUE KEY `clients_number_of_appliances_unique` (`number_of_appliances`),
  ADD UNIQUE KEY `clients_number_of_residents_unique` (`number_of_residents`),
